...
export default function TeamLeaders() {
  ...
  return <div className="flex flex-col mt-12 items-center p-4 relative min-h-[400px] bg-white dark:bg-black transition-colors duration-300">
    ...
    <div className="mb-12 text-center">
        ...
        <p className="mt-4 max-w-3xl mx-auto text-muted-foreground text-base md:text-lg">
          Our club is guided by dedicated leaders who are passionate about learning,
          collaboration, and community growth. Each leader plays a key role in shaping
          activities, supporting members, and building a strong reading culture.
        </p>
      </div>
