...
const FileIcon = () => <svg className="w-5 h-5 mr-2 text-gray-500 dark:text-gray-400 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
  </svg>;
const JsIcon = () => <svg className="w-5 h-5 mr-2 shrink-0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
...
const HtmlIcon = () => <svg className="w-5 h-5 mr-2 shrink-0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
...
const CssIcon = () => <svg className="w-5 h-5 mr-2 shrink-0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
...
const ReactIcon = () => <svg className="w-5 h-5 mr-2 text-cyan-400 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const TreeNode = ({
  ...
  return <div className="text-gray-700 dark:text-gray-300 relative">
      <div className={`flex items-center py-1.5 px-2 rounded-md cursor-pointer transition-colors duration-150 ${isSelected ? "bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-white" : "hover:bg-gray-100 dark:hover:bg-gray-800"}`} onClick={handleToggle}>
      ...
      <div className={`pl-4 relative overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? "max-h-[1000px]" : "max-h-0"}`}>
        ...
        {isFolder && isOpen && item.children && item.children.map(child => <TreeNode key={child.name} item={child} selectedFile={selectedFile} onFileSelect={onFileSelect} />)}
      </div>
    </div>;
};
export default function FileTree() {
  ...
  return <div className="font-mono p-4 bg-white dark:bg-black rounded-lg border border-gray-200 dark:border-gray-800">
      <div className="w-full max-w-xs">
        {fileTreeData.map(item => <TreeNode key={item.name} item={item} selectedFile={selectedFile} onFileSelect={handleFileSelect} />)}
      </div>
    </div>;
}